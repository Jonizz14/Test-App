...
class EnhancedApiService {
  ...
  async performRequest(url, config, _endpoint, _options) {
    try {
  ...
  async updateUser(id, data, _loadingCallback) {
  ...
  async deleteUser(id, _loadingCallback) {
  ...
  async createTest(data, _loadingCallback) {
  ...
  async updateTest(id, data, _loadingCallback) {
  ...
  async deleteTest(id, _loadingCallback) {
  ...
  async createQuestion(data, _loadingCallback) {
  ...
  async updateQuestion(id, data, _loadingCallback) {
  ...
  async deleteQuestion(id, _loadingCallback) {
  ...
  async createAttempt(data, _loadingCallback) {
    return this.post('/attempts/', data);
  }

  async updateAttempt(id, data, _loadingCallback) {
  ...
  async startSession(testId, _loadingCallback) {
  ...
  async updateSessionAnswers(sessionId, answers, _loadingCallback) {
  ...
  async completeSession(sessionId, _loadingCallback) {
  ...
  async autoExpireSessions(_loadingCallback) {
  ...
  async createPricing(data, _loadingCallback) {
  ...
  async updatePricing(id, data, _loadingCallback) {
  ...
  async deletePricing(id, _loadingCallback) {
  ...
  async createStarPackage(data, _loadingCallback) {
  ...
  async updateStarPackage(id, data, _loadingCallback) {
  ...
  async deleteStarPackage(id, _loadingCallback) {
  ...
  async createGift(data, _loadingCallback) {
  ...
  async updateGift(id, data, _loadingCallback) {
  ...
  async deleteGift(id, _loadingCallback) {
  ...
  async purchaseGift(giftId, _loadingCallback) {
  ...
  async placeGift(studentGiftId, position, _loadingCallback) {
  ...
  async selectPlan(planType, _loadingCallback) {
  ...
  async approvePlan(userId, _loadingCallback) {
  ...
  async submitContactMessage(data, _loadingCallback) {
    return this.post('/contact-messages/', data);
  }

  async updateContactMessageStatus(messageId, data, _loadingCallback) {
  ...
  async replyToContactMessage(messageId, data, _loadingCallback) {
  ...
  async editContactMessage(messageId, data, _loadingCallback) {
    return this.put(`/contact-messages/${messageId}/edit_message/`, data);
  }

  async deleteContactMessage(messageId, _loadingCallback) {
  ...
  async deleteStudentProfileData(studentId, _loadingCallback) {
